...
namespace MoreLeviathanSpawns
{
    ...
    public class SpawnData
    {
        ...
        public List<GhostCoordsAndType> GhostCoords = new List<GhostCoordsAndType>
        {
            ...
            new GhostCoordsAndType { Coords = new Vector3( -284, -293, 1100 ), GhostType = 1 }, //Adult, Underwater Islands, North
            new GhostCoordsAndType { Coords = new Vector3( 1065, -211, 466 ), GhostType = 1 }, //Adult, Bulb Zone, East-North-East
            new GhostCoordsAndType { Coords = new Vector3( 876, -122, 881 ), GhostType = 1 }, //Adult, Bulb Zone, North-East
            new GhostCoordsAndType { Coords = new Vector3( -28, -318, 1296 ), GhostType = 1 }, //Adult, Mountains, North
            new GhostCoordsAndType { Coords = new Vector3( 10, -219, -220 ), GhostType = 2 }, //Juvenile, Jellyshroom Cave, South
            new GhostCoordsAndType { Coords = new Vector3( -396, -350, -925 ), GhostType = 2 }, //Juvenile, Grand Reef, South
            new GhostCoordsAndType { Coords = new Vector3( -958, -300, -540 ), GhostType = 2 }, //Juvenile, Blood Kelp Trench, South-West
            new GhostCoordsAndType { Coords = new Vector3( -988, -885, 400 ), GhostType = 2 }, //Juvenile, Lost River, West-North-West (Tree Cove)
            new GhostCoordsAndType { Coords = new Vector3( -695, -478, -993 ), GhostType = 2 }, //Juvenile, Grand Reef, South-South-West (Degasi Base)
            new GhostCoordsAndType { Coords = new Vector3( -618, -213, -82 ), GhostType = 2 }, //Juvenile, Jellyshroom Cave, West
            new GhostCoordsAndType { Coords = new Vector3( -34, -400, 926 ), GhostType = 2 }, //Juvenile, Underwater Islands, North
            new GhostCoordsAndType { Coords = new Vector3( -196, -436, 1056 ), GhostType = 2 }, //Juvenile, Underwater Islands, North
            new GhostCoordsAndType { Coords = new Vector3( 1443, -260, 883 ), GhostType = 2 }, //Juvenile, Bulb Zone, North-East
            new GhostCoordsAndType { Coords = new Vector3( 1075, -475, 944 ), GhostType = 2 } //Juvenile, Mountains, North-East (Lost River Entrance)
        };
    }
    #endregion
}
